...
<div class="sl-mainpanel">
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            @if($order->status == 0)
            <a href="{{ url('admin/payment/accept/'.$order->id) }}" class="btn btn-primary">Accept Payment </a>
            ...
            @elseif($order->status == 2)
            <a href="{{ url('admin/delevery/done/'.$order->id) }}" class="btn btn-success">Complete Delevery </a>
            @elseif($order->status == 4)
            <h4 class="text-danger text-center"> This Order is Cancelled and Not Valid </h4>
            @else
            <h4 class="text-success text-center"> This Order is Successfuly Delivered </h4>
            @endif
