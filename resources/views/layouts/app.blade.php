...
<head>
	...
	<!-- Google Font -->
	<link href="https://fonts.googleapis.com/css2?family=Lato:wght@200;300;400;600;900&display=swap" rel="stylesheet">
	<!-- Css Styles -->
...
<body>
	...
	<a href="#" id="scrollTop" title="Go to Top"><span></span></a>
	<!-- Humberger Begin -->
	...
	<div class="humberger__menu__wrapper">
		...
		<div class="humberger__menu__cart">
			<ul>
				...
				@endphp
				<li><a href="{{route('user.wishlist')}}"><i class="fa fa-heart"></i>
						<span class="wishlist_count">{{count($wishlist)}}</span></a></li>
				@endguest
				<li><a href="{{route('show.cart')}}"><i class="fa fa-shopping-bag"></i>
						<span class="count_cart">{{Cart::count()}}</span></a></li>
			</ul>
			<div class="header__cart__price">Tk.<span class="price_cart">{{Cart::subtotal()}}</span></div>
		</div>
						...
						<div class="footer__copyright__text">
							<p>
								...
								Copyright &copy;<script>
									...
									aria-hidden="true"></i> by <a href="http://findhasan.herokuapp.com/"
									target="_blank">Muhammad Hasan</a>
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</p>
						</div>
						<div class="footer__copyright__payment">
							<ul>
								<li><img src="{{asset('public/frontend/img/bkash.png')}}" alt=""></li>
								<li><img src="{{asset('public/frontend/img/rocket.png')}}" alt=""></li>
								<li><img src="{{asset('public/frontend/img/nogod.png')}}" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<script>
		$(document).on("click", "#return", function(e){
				 ...
				 var link = $(this).attr("href");
					swal({
					  title: "Do You Really Want to Return This Product?",
